...
// Date: 11/13/18
/*
   I DID MINDBENDERHELPER EXTENSION
*/
/*****************************************
...
public class ListLabReverse
{
   ...
   public static ListNode reverseBuildNew(ListNode head)
   {
      ...
      while (pointer2 != null) {
         pointer = new ListNode(pointer2.getValue(), pointer);
   ...
   ********************************************************/
   public static ListNode recurTwoPointers(ListNode prev, ListNode head)
   {
      ...
      ListNode reverse = recurTwoPointers(placeholder, prev);
      prev.setNext(head);
      return reverse;
   } 
   ...
   public static ListNode recurPointersAppend(ListNode head)
   {
      ...
      head.setNext(null);
      ListNode reverse = recurPointersAppend(pointer);
      pointer.setNext(head);
      return append(reverse, pointer);
   }
