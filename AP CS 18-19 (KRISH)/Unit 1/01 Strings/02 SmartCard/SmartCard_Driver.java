...
public class SmartCard_Driver
{
   public static void main(String[] args) 
   {
      ...
      SmartCard derek = new SmartCard(2.50);
      derek.board(center);
      derek.disembark(uptown);
      System.out.println();
      
      SmartCard jakob = new SmartCard(4.50);
      jakob.board(uptown);
      jakob.disembark(downtown);
      System.out.println();
      
      SmartCard pete = new SmartCard(7.60);
      pete.board(suburbia);
      pete.disembark(suburbia);
      System.out.println();
